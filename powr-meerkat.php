<?php
    /**
     * @package POWr Meerkat
     * @version 1.4
     */
    /*
    Plugin Name: POWr Meerkat
    Plugin URI: http://www.powr.io
    Description: Livestream videos to any website!  Drop the widget anywhere in your theme. Or use the POWr icon in your WP text editor to add to a page or post. Edit on your live page by clicking the settings icon. More plugins and tutorials at POWr.io.
    Author: POWr.io
    Version: 1.4
    ...
    */
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////Create Meerkat widget/////////////////////////////////
    class Powr_Meerkat extends WP_Widget{
      //Create the widget
      public function __construct(){
        parent::__construct( 'powr_meerkat',
                             __( 'POWr Meerkat' ),
                             array( 'description' => __( 'Meerkat by POWr.io') )
        );
      }
      //This prints the div
      public function widget( $args, $instance ){
        ...
        ?>
        <div class='widget powr-meerkat' label='<?php echo $label; ?>'></div>
        <?php
      }
      ...
      public function form( $instance ){
        ?>
        <p>
          No need to edit here - just click the gears icon on your Meerkat.
        </p>
        <p>
    ...
    function register_powr_meerkat() {
      register_widget( 'Powr_Meerkat' );
    }
    //Use widgets_init action hook to execute custom function
    add_action( 'widgets_init', 'register_powr_meerkat' );
    //Create short codes for adding plugins anywhere:
    function powr_meerkat_shortcode( $atts ){
      if(isset($atts['label'])){
        $label = $atts['label'];
      }else{
        $label = '';
      }
      return "<div class='powr-meerkat' label='$label'></div>";
    }
    add_shortcode( 'powr-meerkat', 'powr_meerkat_shortcode' );
